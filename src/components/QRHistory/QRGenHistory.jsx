...
export const QRGenHistory = () => {
    ...
    return (
        <div className={s.container}>
            <h1 className={s.container__title}>История генерации QR-кодов</h1>
            <div className={s["container__history"]}>
                {JSON.parse(localStorage.getItem(GENERATE_DATA) || '[]').slice(0, 1000).map((item, index) => (
